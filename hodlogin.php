...
$sql = "SELECT * FROM hodlogin WHERE username = '$username' and password = '$password'";
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-RED">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mx-3 text-black fs-5" href="hodlogin.php"><u>HOD Login</u></a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-4">
                    ...
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <input type="username" class="form-control" id="exampleInputusername"
                                aria-describedby="emailHelp" name="txtUser">
              ...
              <button type="button" class="btn btn-outline-primary"><a class="nav-link"
                  href="hodpage.php">Submit</a></button> -->
